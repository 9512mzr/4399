...
<body>
	...
	<div class="wrap_right">
		...
		<div id="Contents">
			...
			<div id="MainForm">
				<div class="form_boxB">
					<c:if test="${sessionScope.worng_studnet!=null&&sessionScope.worng_studnet!='[]'}">
						<h2>
							<p1>选择您要找的学生</p1>
						</h2>
					</c:if>
					<table cellpadding="0" cellspacing="0">
						<c:forEach items="${sessionScope.worng_studnet}" var="Student">
							<tr>
								<a href="${ctx }/Judge/getStudnetWrongDate?id=${Student.id }" >        ${Student.name }</a>
								<br>
							</tr>
						</c:forEach>
						<c:if test="${sessionScope.dates==worng_studnet||sessionScope.worng_studnet=='[]'}">
							<p>没有题</p>
						</c:if>
					</table>
				</div>
