...
<link rel="icon" href="https://www.21cnjy.com/favicon.ico"
	mce_href="//www.21cnjy.com/favicon.ico" type="image/x-icon">
<script>
	// 全局空间
	var ns = {};
	ns.CSRF = {
		"_csrf" : "aDAwSURBZTEkRmAODxsceCcDBBEzeVVSRUMHM3wmH18SVmARLSUgAg=="
	};
	ns.setting = {
		gender : {
			1 : {
...
<body>
		...
		<div class="heading-main">
			...
			<div class="r-wrap">
				...
				<div class="heading-exit">
					...
					<span>${list1.nickName}</span> <a href="login.jsp" target="_self">【退出】</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="g-cw1 cfx">
		...
		<div class="user-sd">
			<dl class="side-list">
				<dt>
					<a href="https://passport.21cnjy.com/site/index"><i
						class="cu-home"></i>我的首页</a>
				</dt>
				...
				<dd>
					<ul class="side-detail">
						<li><a href="https://passport.21cnjy.com/account/profile"><i
								class="cu-dot"></i>个人资料</a></li>
						<li><a href="https://passport.21cnjy.com/account/photo"><i
								class="cu-dot"></i>头像设置</a></li>
						<li class="cur-nav"><a
							href="https://passport.21cnjy.com/account/reset-pwd"><i
								class="cu-dot"></i>更改密码</a></li>
						<li><a href="https://passport.21cnjy.com/account/security"><i
								class="cu-dot"></i>账号安全</a></li>
						<li><a href="https://passport.21cnjy.com/account/bind"><i
								class="cu-dot"></i>账号绑定</a></li>
					</ul>
				</dd>

				<dt>
					<a href="javascript:;"><i class="cu-manage"></i>账户管理</a>
				</dt>
				<dd>
					<ul class="side-detail">
						<li><a href="https://passport.21cnjy.com/finance/coins"><i
								class="cu-dot"></i>学币管理</a></li>
						<li><a href="https://passport.21cnjy.com/finance/points"><i
								class="cu-dot"></i>积分管理</a></li>
					</ul>
				</dd>
			</dl>
		</div>
		<div class="w">
			<div class="user-mn">
				...
				<div class="pwd-wrap cfx" id="pwd-panel1" style="display: none">
					<form class="reg-form"
						action="https://passport.21cnjy.com/account/reset-pwd"
						method="post">
						<input type="hidden" name="_csrf"
							value="aDAwSURBZTEkRmAODxsceCcDBBEzeVVSRUMHM3wmH18SVmARLSUgAg==">
						<div class="form-line">
							...
							<div class="set-input" id="mobile-captcha-template">
								...
								<div class="input-b">
									<input type="text" name="verifyCode" id="verifyCode"
										class="code-txt" placeholder="图形验证码">
								</div>
								<img id="mobile-captcha" src="${ctx }/static/images/captcha"
									alt="换一个" title="换一个" style="cursor: pointer;">
							</div>
						</div>
						<div class="form-line">
							...
							<div class="set-input">
								<div class="input-b">
									<input type="text" name="scode" id="scode" class="code-txt"
										placeholder="请输入验证码">
								</div>
								<a href="https://passport.21cnjy.com/site/send-code?do=9"
									class="get-code" id="get_code" data-type="mobile"
									style="width: 102px;">获取验证码</a>
							</div>
						</div>
						<div class="form-line">
							<label for="password">新密码：</label>
						...
						<div class="form-line">
							<label for="password2">重复密码：</label>
							<div class="set-input">
								<input type="password" name="password2" id="password4"
									placeholder="请输入新的登录密码">
							</div>
						</div>
						<button class="right-btn" type="submit">确认</button>
	...
	<div class="address">
		<p>
			<span> 地址：深圳市龙岗区横岗街道深峰路3号启航商务大厦5楼5M</span><span> 邮编：518000</span><span>电话：0775-25526569</span>
		</p>
	...
	<script src="./21教育_files/common-form.min.js.下载"></script>
	<script src="./21教育_files/reset-pwd.min.js.下载"></script>
	<script>
