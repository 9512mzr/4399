...
<link rel="stylesheet" type="text/css"
	href="${ctx }/backstage/css/css.css" />
...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="${ctx }/backstage/images/coin02.png" /><span><a
					href="#">首页</a>&nbsp;-&nbsp;<a href="#">公共管理</a>&nbsp;-</span>&nbsp;修改密码
			</div>
		</div>
		<div class="page ">
			<!-- 修改密码页面样式 -->
			<div class="bacen">
				...
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						...
						src="${ctx }/backstage/images/ok.png" /><img class="imgb"
						src="${ctx }/backstage/images/no.png" />
				</div>
				<div class="bbD">
