...
<!-- <script type="text/javascript" src="${ctx }/backstage/js/page.js" ></script> -->
</head>
...
<body>
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="${ctx }/backstage/images/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;-</span>&nbsp;管理员管理
			</div>
		</div>
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr height="40px">
							...
							<td><a href="useradd.jsp"><img class="operation"
									src="${ctx }/backstage/images/update.png"></a> <img class="operation delban"
								src="${ctx }/backstage/images/delete.png"></td>
						</tr>
					</table>
	...
	<div class="banDel">
		<div class="delete">
			<div class="close">
				<a><img src="${ctx }/backstage/images/shanchu.png" /></a>
			</div>
